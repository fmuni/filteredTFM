...
namespace microDragClosures
{
    ...
    addToRunTimeSelectionTable(microDragClosure, MorrisBoulay, dictionary);
}
}
...
Foam::microDragClosures::MorrisBoulay::MorrisBoulay
(
...
:
    ...
    alphaFit_(4.1)  // Donstov and Pierce (2014)
{}
