...
namespace microDragClosures
{
    ...
    addToRunTimeSelectionTable(microDragClosure, GidaspowSchillerNaumann, dictionary);
}
}
...
Foam::microDragClosures::GidaspowSchillerNaumann::GidaspowSchillerNaumann
(
...
Foam::microDragClosures::GidaspowSchillerNaumann::CdRe() const
{
